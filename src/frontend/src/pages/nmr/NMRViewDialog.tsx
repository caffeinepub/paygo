...
export default function NMRViewDialog({
  open,
  onOpenChange,
  nmr,
}: NMRViewDialogProps) {
  ...
  const totalAmount = nmr.entries.reduce(
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="border rounded-lg overflow-x-auto">
              <Table>
                ...
                <TableBody>
                  {nmr.entries.map((entry: any) => (
                    <TableRow
                      key={`${entry.date}-${entry.labourType}-${entry.noOfPersons}`}
                    >
          ...
          <div className="border-t pt-4">
            ...
            <div className="space-y-3">
              <div className="bg-slate-50 p-3 rounded">
                ...
                {nmr.pmDebit > 0 && (
                  <p className="text-sm">
                    Debit: {formatCurrency(nmr.pmDebit)}
                  </p>
                )}
                {nmr.pmNote && (
              ...
              <div className="bg-slate-50 p-3 rounded">
                ...
                {nmr.qcDebit > 0 && (
                  <p className="text-sm">
                    Debit: {formatCurrency(nmr.qcDebit)}
                  </p>
                )}
                {nmr.qcNote && (
                  <p className="text-sm text-muted-foreground">
              ...
              <div className="bg-slate-50 p-3 rounded">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Badge
                    variant={nmr.billingApproved ? "default" : "secondary"}
                  >
          ...
          <div className="border-t pt-4">
            ...
            <p className="text-2xl font-bold text-green-600">
              {formatCurrency(nmr.finalAmount)}
            </p>
          </div>
        </div>
      </DialogContent>
